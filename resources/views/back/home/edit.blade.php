...
<form action="{{route('home.update',$home->id)}}" method="POST" enctype="multipart/form-data">
        ...
        @method('PATCH')
            ...
            <div class="form-group row mt-4">
                    ...
                    <div class="col-sm-8">
                        <input type="text" class="form-control boxed" name="hsize" required autofocus value="{{ $home->hsize }}">
                    </div>
            </div>
            <div class="form-group row mt-4">
                <label for="floor" class="col-sm-4">Land Size</label>
                <div class="col-sm-8">
                    <input type="text" class="form-control boxed" name="lsize"  required value="{{ $home->lsize }}">
                </div>
             </div>
             <div class="form-group row mt-4">
                <label for="bedroom" class="col-sm-4">Bedroom</label>
                <div class="col-sm-8">
                    <input type="number" class="form-control boxed" name="bedroom" value="{{ $home->bedroom }}" min="1">
                </div>
             </div>
            <div class="form-group row">
                <label for="Location" class="col-sm-4">Basroom</label>
                <div class="col-sm-8">
                    <input type="number" class="form-control boxed" name ='basroom' required min="1" value="{{ $home->basroom }}">
                </div>
            </div>
            <div class="form-group row">
                <label for="Location" class="col-sm-4">Type</label>
                <div class="col-sm-8">
                    <input type="text" class="form-control boxed" name ='type' required value="{{ $home->type }}">
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-8">
                    <input type="text" class="form-control boxed" name ='price' required value="{{ $home->price }}">
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-8">
                    <select name="location_id" id="" class="chosen-select  boxed">
                        @foreach ($local as $l)
                        <option value="{{ $l->id }}" {{ $l->id==$home->location_id?'selected':'' }}>{{ $l->name }}</option>
                    @endforeach
                </select>
                </div>
             </div>
              <div class="form-group row">
                 ...
                 <div class="col-sm-8">
                     <textarea name="potaintial" id="" cols="30" rows="2" class="form-control boxed">{{ $home->potaintial }}</textarea>
                 </div>
              </div>
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-8">
                    <textarea name="description" id="" cols="30" rows="2" class="form-control boxed">{{ $home->description }}</textarea>
                </div>
             </div>
             <div class="form-group row">
                ...
                <div class="col-sm-8">
                    <select name="for_id" id="" class="form-control boxed">
                        ...
                        @foreach ($for as $f)
                       <option value="{{$f->id}}" class="form-control boxed" {{$f->id == $home->for_id?'selected':''}}>{{$f->name}}</option>
                        @endforeach
                    </select>
                  </div>
             </div>
          ...
          <div class="col-sm-2">
            <div class="mt-4">
                ...
                <img src="{{ asset($home->photo) }}" alt="" width="200" id="img" class="mt-2">
            </div>
          </div>
      </div>
    </form>
