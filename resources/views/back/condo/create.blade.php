...
@section('content')
<form action="{{route('condo.store')}}" method="POST" enctype="multipart/form-data">
        @csrf
            ...
            <div class="form-group row mt-4">
                    ...
                    <div class="col-sm-8">
                        <input type="text" class="form-control boxed" name="name" required autofocus >
                    </div>
            </div>
            <div class="form-group row mt-4">
                ...
                <div class="col-sm-8">
                        ...
                        <select name="location_id" id="" class="chosen-select ">
             ...
             <div class="form-group row mt-4">
                ...
                <div class="col-sm-8">
                 <input type="text" name="price" class="form-control boxed" id="">
                </div>
             </div>
          ...
          <div class="col-sm-5 mt-4">
            <div class="">
                <input type="file" id="real-file" hidden="hidden"  onchange="preview(event)" name="bigphoto" required>
            ...
            <div class="mt-5">
                <div class="form-group">
                    <input type="file" id="real-files" hidden="hidden"  onchange="pview(event)" name="photo[]" required multiple>

                    <span type="buttons" id="custom-buttons" class="btn btn-warning btn-oval "><i class="fa fa-folder-open"></i> Browse</span>
