...
<form action="{{route('apartment.store')}}" method="POST" enctype="multipart/form-data">
        @csrf
            ...
            <div class="form-group row mt-4">
                    ...
                    <div class="col-sm-8">
                        <input type="text" class="form-control boxed" name="size" required autofocus>
                    </div>
            </div>
            <div class="form-group row mt-4">
                <label for="floor" class="col-sm-4">Floor</label>
                <div class="col-sm-8">
                    <input type="text" class="form-control boxed" name="floor"  required>
                </div>
             </div>
             <div class="form-group row mt-4">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-8">
                    <input type="number" class="form-control boxed" name ='besroom' required min="1" value="1">
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-8">
                  <input type="text" name="freespace" id="" class="form-control boxed">
                </div>
             </div>
          ...
          <div class="col-sm-5 mt-4">
            <div class="form-group row">
                ...
                <div class="col-sm-8">
                        ...
                        <select name="location_id" id="" class="chosen-select form-control boxed" required>
          ...
          <div class="col-sm-2">
            <div class="mt-4">
                <input type="file" id="real-file" hidden="hidden"  onchange="preview(event)" name="photo" multiple required>
