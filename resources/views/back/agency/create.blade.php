...
<form action="{{route('agency.store')}}" method="POST" enctype="multipart/form-data">
        @csrf
            ...
            <div class="form-group row mt-4">
                    ...
                    <div class="col-sm-8">
                        <input type="text" class="form-control boxed" name="name" required placeholder="name">
                    </div>
            </div>
            <div class="form-group row">
                <label for="position" class="col-sm-4">Position</label>
                <div class="col-sm-8">
                    <input type="text" class="form-control boxed" name ='position' placeholder="position">
                </div>
            </div>
            <div class="form-group row">
                <label for="email" class="col-sm-4">Email</label>
                <div class="col-sm-8">
                    <input type="email" name="email" id="" class="form-control boxed" placeholder="email">
                </div>
            </div>
            <div class="form-group row">
                <label for="Location" class="col-sm-4">Phone</label>
                <div class="col-sm-8">
                    <input type="text" name="phone" id=""  class="form-control boxed" required placeholder="phone">
                </div>
            </div>
            <div class="form-group row">
